 ...
 * @author Hoang
 */
public class AdminListCarController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            ArrayList<CarDTO> listcar = new CarDAO().getAllCarAdmin();
            ...
            Logger.getLogger(AdminListCarController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
